...
class GlanceController: WKInterfaceController {
    ...
    func getSpaceData(){
        ...
        self.updateTitleLabelWithUsedSpace(usedSpace)
    ...
    func updateTitleLabelWithUsedSpace (usedSpace: NSNumber){
        
        self.titleLabel.setText(DiskDataManager.memoryFormatter(usedSpace.longLongValue) +  " Used")
