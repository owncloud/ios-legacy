...
html_short_title = "iOS App Manual"
...
htmlhelp_basename = 'ownCloudiOSAppManual'
...
man_pages = [
    ('owncloud.1', 'owncloud', u'iOS synchronisation and file management utility.',
     [u'The ownCloud developers'], 1),
    ('owncloudcmd.1', 'owncloudcmd', u'ownCloud iOS app.',
     [u'The ownCloud developers'], 1),
]
...
texinfo_documents = [
  ('index', 'ownCloudClientManual', u'ownCloud iOS App Manual',
   u'The ownCloud developers', 'ownCloud', 'The ownCloud iOS App Manual.',
   'Miscellaneous'),
]
