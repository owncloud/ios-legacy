...
//Add this method to select/unselect manually
- (void)setSelectedStrong:(BOOL)isSelected{
...
///-----------------------------------
/// @name hideUtilityButtonsAnimated
///-----------------------------------

/**
 * Method to close the swipe programatically
 *
 * @param BOOL -> animated
 */
...
- (void)showUtilityButtonsAnimated:(BOOL)animated
{
    ...
    // Force the scroll back to run on the main thread because of weird scroll view bugs
    dispatch_async(dispatch_get_main_queue(), ^{
        [self.cellScrollView setContentOffset:CGPointMake([self rightUtilityButtonsWidth], 0) animated:NO];
    });
...
//Add this method to unselect the cell when begin the scrolling
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView{
    
     [self setSelectedStrong:NO];
