...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *cancelButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"cancel", nil) style:UIBarStyleDefault target:self action:@selector(cancel:)];
